/*
=============================================================================
URBANO Col2 | Workflow 05 (variant: MOSAIC) — Post-processing Filters
...
See workflow/filters/05_postprocessing_filter-max.js for the same
pipeline run on the alternative ("max") national integration.
...
OUTPUT: Post-processed national classification, exported as
        `urban-col2-filter-mosaic`.

PREVIOUS STEP: 04b-integration-mosaic.js
NEXT STEP:     05b_postprocessing_steps_filter-mosaic.js (step-by-step /
               diagnostic variant of this same pipeline)
=============================================================================
*/
...
var output_name   = "urban-col2-filter-mosaic";
...
var description = "urban-col2-filter-mosaic | A-GapFill(no-op) + B-TF5yearsUnique(2025 excl) + C-TFbreakPoint(finalYear=2025) + D-SF(holes<" + thres_SF_hole + "px + noise<" + thres_SF_noise + "px, eightConnected=false)";
