// ============================================================
// URBANO Col2 | Workflow 01 — Probability Map (base + complementary points)
// ============================================================
//
...
//   the complementary points improve the result before deciding to feed
//   them into the exported probability map (workflow/02-probability-export.js).
//
// This is the blank template — the ../MuestrasComplementarias/ folder
// holds 15 saved copies of this exact script, one per ecoregion, each
// with that ecoregion's own hand-drawn correction polygons and
// `listEcoregions` selection filled in.
//
// METHODOLOGY:
...
//      merged in.
//   4. Add both classifications as map layers for visual comparison.
//
// INPUT:
//   - Hand-drawn correction polygons for the ecoregion being reviewed
//     (SECTION 2 imports — empty by default in this template).
...
//
// OUTPUT:
//   None exported — this is a visual QA tool.
//
// USAGE NOTE: uncomment ONE (or more) ecoregion name(s) in
// `listEcoregions` (SECTION 3) to process it/them, and fill in SECTION 2
// with that ecoregion's own hand-drawn corrections.
//
// PREVIOUS STEP: none — first script in the pipeline
// NEXT STEP:     02-probability-export.js (exports the probability map,
//                once the complementary points reviewed here are folded
//                into the base sample set)
//
